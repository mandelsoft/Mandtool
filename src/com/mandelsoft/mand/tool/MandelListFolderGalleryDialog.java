 ...
 * @author Uwe Krueger
 */
public class MandelListFolderGalleryDialog extends MandelDialog {
  private MandelListFolderListModel model;
  private Listener listener;

  public MandelListFolderGalleryDialog(MandelWindowAccess owner,
                            ...
                            MandelListFolder folder)
  {
    ...
    MandelListFolderGalleryPanel p=new MandelListFolderGalleryPanel(model);
    add(p);
    pack();
