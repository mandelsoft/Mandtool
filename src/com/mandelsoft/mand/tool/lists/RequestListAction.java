...
import com.mandelsoft.mand.util.lists.RequestFactory;

/**
 *
 * @author Uwe Krueger
 */
public class RequestListAction extends MandelListViewAction {
  ...
  {
    return new RequestFactory(getMandelScanner(),n.getMandelName());
  }
}
