...
import com.mandelsoft.mand.util.lists.ParentAreasFactory;

/**
 *
 * @author Uwe Krueger
 */
public class ParentListAction extends MandelListViewAction {

  public ParentListAction()
  {
    super("Parent Areas");
  }
  ...
  {
    return new ParentAreasFactory(n.getMandelName());
  }
}
