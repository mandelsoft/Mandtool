...
import com.mandelsoft.swing.GalleryPanel;
 ...
 * @author Uwe Krueger
 */
public abstract class MandelGalleryPanel<E,M extends ThumbnailListModel<E>>
                      extends GalleryPanel<E,M> {
  private boolean modifiable;;

  public MandelGalleryPanel(M model)
  {
    this(model,1,null);
  }
  
  public MandelGalleryPanel(M model, int rows, Dimension d)
  {
    super(model,rows,d);
  }
