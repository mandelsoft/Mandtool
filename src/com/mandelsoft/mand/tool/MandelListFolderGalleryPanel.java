 ...
 * @author Uwe Krueger
 */
public class MandelListFolderGalleryPanel
        extends MandelGalleryPanel<MandelListFolder, MandelListFolderListModel>
         {

  private ContextHandler contextHandler;

  public MandelListFolderGalleryPanel(MandelListFolderListModel model)
  {
    this(model, 1, new Dimension(100, 100));
  }

  public MandelListFolderGalleryPanel(MandelListFolderListModel model, int rows,
                                     Dimension d)
  {
    super(model, rows, d);
  ...
  {
    super.panelUnbound();
    System.out.println("cleanup folder gallery");
  ...
  private class ContextHandler extends MandelListFolderContextMenuHandler
    ...
    private class BackAction extends ContextAction {
      ...
      {
        MandelListFolderListModel model=MandelListFolderGalleryPanel.this.getModel();
    ...
    public void handleContextMenu(JComponent comp, MouseEvent evt, Selection sel)
    {
      ...
      model=MandelListFolderGalleryPanel.this.getModel();
