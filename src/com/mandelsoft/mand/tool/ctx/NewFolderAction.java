...
public class NewFolderAction
  ...
  public NewFolderAction(ContextProvider<MandelListFolder,TreePath,MandelListFolderTreeModel> p)
  {
    super("New Folder",p);
  }
  ...
  {
    MandelListFolder parent=getSelectedItem();
    if (parent!=null) {
      getModel().insertFolder("new folder", parent);
    }
  }
}
