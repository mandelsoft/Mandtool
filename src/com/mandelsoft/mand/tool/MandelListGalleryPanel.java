 ...
 * @author Uwe Krueger
 */
public class MandelListGalleryPanel
             extends MandelGalleryPanel<QualifiedMandelName,MandelListListModel>
  ...
  public MandelListGalleryPanel(MandelListListModel model)
  {
   this(model,1);
  }

  public MandelListGalleryPanel(MandelListListModel model, int rows, Dimension d)
  {
    super(model,rows, d);
  ...
  public MandelListGalleryPanel(MandelListListModel model, int rows)
  {
  ...
  private class ContextHandler extends MandelListContextMenuHandler
    ...
    {
      return MandelListGalleryPanel.this.getMaxFrame();
    }
