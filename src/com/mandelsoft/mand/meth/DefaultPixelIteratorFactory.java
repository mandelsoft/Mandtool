 ...
 * @author Uwe Krueger
 */
public class DefaultPixelIteratorFactory extends MandArith
  ...
  private static class DoubleJuliaIterator extends DoubleMandIterator {
    protected double jx;
    protected double jy;
  ...
  private static class LongDoubleJuliaIterator extends LongDoubleMandIterator {
    ...
    public int iter()
    {
      return MandIter.iterP(scx, scy, sjx, sjy, bound, limit, precision);
    }
  }
  ...
  private static class BigDecimalMandIterator extends AbstractBigDecimalPixelIterator {
    ...
    protected int _iter()
    {
      return iter(BigDecimal.ZERO, BigDecimal.ZERO, cx, cy, bound, limit);
    }
  ...
  private static class BigDecimalJuliaIterator extends BigDecimalMandIterator {
    protected BigDecimal jx;
    protected BigDecimal jy;
    
    public BigDecimalJuliaIterator(BigDecimal jx,
                                   BigDecimal jy,
                                   BigDecimal x0,
                                   BigDecimal y0,
                                   BigDecimal dx,
