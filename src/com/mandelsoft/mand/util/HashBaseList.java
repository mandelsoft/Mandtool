...
abstract public class HashBaseList<T> implements BaseList<T> {

  private HashList<T> list;

  public HashBaseList(Collection<? extends T> c)
  {
    list=new HashList(c);
  }
  ...
  {
    HashBaseList<T> c=(HashBaseList<T>)super.clone();
    c.list=(List<T>)(list.clone());
    return c;
  }
*/
}
