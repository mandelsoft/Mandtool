 ...
 * @author Uwe Krueger
 */
public class TitleSubareaFactory extends SubAreaFactory {

  public TitleSubareaFactory(MandelScanner scanner, MandelName basename,
                           String title)
  {
  ...
  protected boolean accept(MandelHandle h)
  {
    ...
    try {
      return h.getInfo().getInfo().hasProperty(MandelInfo.ATTR_TITLE);
    }
