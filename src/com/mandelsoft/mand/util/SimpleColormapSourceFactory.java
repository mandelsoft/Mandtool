 ...
 * @author Uwe Krueger
 */
public class SimpleColormapSourceFactory implements ColormapSourceFactory {
  private ColormapSource src;

  public SimpleColormapSourceFactory(ColormapSource src)
  {
    this.src=src;
  }
